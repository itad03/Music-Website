...
if (isset($_REQUEST['submit']) and $_REQUEST['submit'] != "") {
    ...
    if ($songName == "") {
        ...
        $songCount = $db->getQueryCount('songs', 'id');
        $data = array(
            'songName' => $songName,
            'poster' => "img/" . $poster,
            'audio' => "audio/" . $audio,
        ...
        $insert = $db->insert('songs', $data);
        if ($insert) {
            header('location:admin_song.php?msg=ras');
            exit;
        } else {
            header('location:admin_song.php?msg=rna');
            exit;
        }
    }
}
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lyric" id="lyric" class="form-control"
                                        placeholder="Enter lyric" required>
